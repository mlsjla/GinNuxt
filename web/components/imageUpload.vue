<template>
    <div class="flex flex-col">
        <el-upload name="file[]" :action="uploadURL" :headers="headers" class="flex image-uploader" :on-success="uploadSuccess" :auto-upload="true" :show-file-list="false">
            <img @click="dialogVisible = true" v-if="previewUrl" :src="previewUrl" class="image" />
